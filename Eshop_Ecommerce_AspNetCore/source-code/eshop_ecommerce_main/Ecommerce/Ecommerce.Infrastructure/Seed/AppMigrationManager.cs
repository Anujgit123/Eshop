...
namespace Ecommerce.Infrastructure.Sql.Seed
{
    public static class AppMigrationManager
    {
        ...
        //private static async Task SeedDefaultShippingAreaAsync(DataContext context)
        //{
        //    var defaultShippingArea = DefaultShippingArea.GetDefaultShippingArea();
        //    if (!await context.ShippingAreas.AnyAsync())
        //    {
        //        foreach (var shippingAreas in defaultShippingArea)
        //        {
        //            await context.ShippingAreas.AddAsync(shippingAreas);
        //        }
