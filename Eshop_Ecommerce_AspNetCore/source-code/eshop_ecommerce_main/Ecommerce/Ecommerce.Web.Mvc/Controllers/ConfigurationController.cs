...
namespace Ecommerce.Web.Mvc.Controllers
{
    ...
    public class ConfigurationController : Controller
    {
        ...
        {
            //var updateGeneralConfiguration = _mapper.Map<UpdateGeneralConfigurationCommand>(generalConfiguration);
        ...
        {
            //var updateHeaderSlider = _mapper.Map<UpdateHeaderSliderConfigurationCommand>(headerSliders);
            if (ModelState.IsValid)
            {
