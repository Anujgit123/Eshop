...
namespace Ecommerce.Web.Mvc.Helpers
{
    public class NavigationMenuHelper
    {
        public List<NavMenu> NavMenuBuilder()
        {
            ...
            navmenu.Add(new NavMenu { Id = 12, ParentMenuId = null, Name = "Customer Review", Key = Permissions.Permissions_ProductReview_View, ControllerName = "ProductReview", ActionName = "Index", IsActive = true, IsVisible = true, MenuIcon = "fas fa-star-half-alt" });
