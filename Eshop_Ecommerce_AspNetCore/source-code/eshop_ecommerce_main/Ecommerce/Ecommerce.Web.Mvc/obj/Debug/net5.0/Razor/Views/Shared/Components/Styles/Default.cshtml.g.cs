#pragma checksum "C:\Users\anujy\Downloads\E_shop\Eshop_Ecommerce_AspNetCore\source-code\eshop_ecommerce_main\Ecommerce\Ecommerce.Web.Mvc\Views\Shared\Components\Styles\Default.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "281a3012ec8046fb6710026494df5673fc5a398e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Shared_Components_Styles_Default), @"mvc.1.0.view", @"/Views/Shared/Components/Styles/Default.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"281a3012ec8046fb6710026494df5673fc5a398e", @"/Views/Shared/Components/Styles/Default.cshtml")]
    ...
    #nullable restore
    public class Views_Shared_Components_Styles_Default : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        {
            WriteLiteral("\r\n\r\n<style>\r\n      ");
            WriteLiteral("@import url(\"https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,400;0,700;0,900;1,300;1,400;1,700;1,900&display=swap\");\r\n      ");
            WriteLiteral("@import url(\"https://fonts.googleapis.com/css2?family=Spartan:wght@300;400;500;600;700&display=swap\");\r\n      ");
            WriteLiteral(@"@import url('https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600;700;800&display=swap');

    :root {
        /* --primary-color: #ff6c80;
    --primary-light: #ffdbe0;
    --primary-color-hover: #ff5e73; */

        --font-family-body: 'Rubik', sans-serif;
        --primary-color: #ffb444;
        --primary-color: #2381c3;
        --secondary-color: #f02757;
        --primary-light: #ffeacb;
        /*--primary-color-hover: #faa11c;*/
        --shop-primary-color: #4674c7;
        /*--shop-primary-color: #3e97dd;*/
        /*--shop-primary-color: #5273b3;*/
        /*--shop-primary-color: #e1c670;*/
        /*--shop-primary-color: #7C9473;*/
        /*--shop-primary-color: #eb8273;*/
        /*--shop-primary-color: #f3ae74;*/
        /*--shop-primary-color: #3fa184;*/
        /*--shop-primary-color: #e5ba4a;*/
        /*--shop-header-menu-bg: #7C947328;*/
        --shop-primary-color-light: #eff1f3;
        --shop-secondary-color: #e5cb78;
    }
